...
class HloInstructionProto(google.protobuf.message.Message):
    ...
    opcode: typing.Text
    @property
    def shape(self) -> xla_data_pb2.ShapeProto: ...
    @property
    def metadata(self) -> xla_data_pb2.OpMetadata: ...
    @property
    def literal(self) -> xla_data_pb2.LiteralProto:
    ...
    def dimensions(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        ...
        pass
    @property
    def window(self) -> xla_data_pb2.Window:
        """Describes the window in a windowed operation such as convolution."""
        pass
    @property
    def convolution_dimension_numbers(self) -> xla_data_pb2.ConvolutionDimensionNumbers:
        """Describes the dimension numbers used for a convolution."""
        pass
    feature_group_count: builtins.int
    """The number of feature groups. Used for a convolution. Must be a divisor
    of the input feature dimension and output feature dimension. If not
    specified, it will use a default value of 1.
    """
    ...
    def dynamic_slice_sizes(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        ...
        ('start' is specified dynamically in the second operand of the
        operation).
        """
        pass
    @property
    def padding_config(self) -> xla_data_pb2.PaddingConfig:
    ...
    distribution: xla_data_pb2.RandomDistribution.ValueType
    ...
    @property
    def outfeed_shape(self) -> xla_data_pb2.ShapeProto:
        """Shape of outfeed request."""
        pass
    @property
    def dot_dimension_numbers(self) -> xla_data_pb2.DotDimensionNumbers:
        """Describes the dimension numbers used for a dot operation"""
        pass
    fft_type: xla_data_pb2.FftType.ValueType
    ...
    @property
    def gather_dimension_numbers(self) -> xla_data_pb2.GatherDimensionNumbers:
    ...
    @property
    def sharding(self) -> xla_data_pb2.OpSharding: ...
    backend_config: builtins.bytes
    """Backend configuration for the instruction. Has backend-specific meaning."""

    @property
    def replica_groups(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla_data_pb2.ReplicaGroup]:
    ...
    @property
    def scatter_dimension_numbers(self) -> xla_data_pb2.ScatterDimensionNumbers: ...
    @property
    def precision_config(self) -> xla_data_pb2.PrecisionConfig:
        """Precision configuration for the instruction. Has backend-specific
        meaning.
        """
        pass
    @property
    def source_target_pairs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla_data_pb2.SourceTarget]:
        """Collective permute field."""
        pass
    @property
    def domain_entry_sharding(self) -> xla_data_pb2.OpSharding:
        """Sharding for kDomain instructions."""
        pass
    @property
    def domain_exit_sharding(self) -> xla_data_pb2.OpSharding: ...
    constrain_layout: builtins.bool
    """For custom call this indicates that the layouts are constrained. If
    constrain_layout is true then the 'shape' field must contain a layout,
    and 'operand_shapes_with_layout' must contain a shape with layout for
    each operand.
    """

    @property
    def operand_shapes_with_layout(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla_data_pb2.ShapeProto]: ...
    @property
    def triangular_solve_options(self) -> xla_data_pb2.TriangularSolveOptions:
        """Options for TriangularSolve"""
        pass
    @property
    def cholesky_options(self) -> xla_data_pb2.CholeskyOptions:
        """Options for Cholesky"""
        pass
    @property
    def parameter_replication(self) -> xla_data_pb2.ParameterReplication:
    ...
    @property
    def custom_call_output_operand_aliasing(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla_data_pb2.CustomCallOutputOperandAliasing]:
    ...
    """Specifies if the gather/scatter indices are guaranteed to be sorted by
    the caller.
    """

    @property
    def frontend_attributes(self) -> xla_data_pb2.FrontendAttributes:
    ...
    rng_algorithm: xla_data_pb2.RandomAlgorithm.ValueType
    ...
    padding_type: xla_data_pb2.PaddingType.ValueType
    ...
    def __init__(self,
        *,
        name: typing.Text = ...,
        opcode: typing.Text = ...,
        shape: typing.Optional[xla_data_pb2.ShapeProto] = ...,
        metadata: typing.Optional[xla_data_pb2.OpMetadata] = ...,
        literal: typing.Optional[xla_data_pb2.LiteralProto] = ...,
        parameter_number: builtins.int = ...,
        fusion_kind: typing.Text = ...,
        tuple_index: builtins.int = ...,
        dimensions: typing.Optional[typing.Iterable[builtins.int]] = ...,
        window: typing.Optional[xla_data_pb2.Window] = ...,
        convolution_dimension_numbers: typing.Optional[xla_data_pb2.ConvolutionDimensionNumbers] = ...,
        feature_group_count: builtins.int = ...,
        batch_group_count: builtins.int = ...,
        ...
        padding_config: typing.Optional[xla_data_pb2.PaddingConfig] = ...,
        outfeed_config: builtins.bytes = ...,
        distribution: xla_data_pb2.RandomDistribution.ValueType = ...,
        epsilon: builtins.float = ...,
        feature_index: builtins.int = ...,
        ...
        infeed_config: builtins.bytes = ...,
        custom_call_target: typing.Text = ...,
        outfeed_shape: typing.Optional[xla_data_pb2.ShapeProto] = ...,
        dot_dimension_numbers: typing.Optional[xla_data_pb2.DotDimensionNumbers] = ...,
        fft_type: xla_data_pb2.FftType.ValueType = ...,
        fft_length: typing.Optional[typing.Iterable[builtins.int]] = ...,
        comparison_direction: typing.Text = ...,
        gather_dimension_numbers: typing.Optional[xla_data_pb2.GatherDimensionNumbers] = ...,
        ...
        sharding: typing.Optional[xla_data_pb2.OpSharding] = ...,
        backend_config: builtins.bytes = ...,
        replica_groups: typing.Optional[typing.Iterable[xla_data_pb2.ReplicaGroup]] = ...,
        all_reduce_id: builtins.int = ...,
        use_global_device_ids: builtins.bool = ...,
        is_host_transfer: builtins.bool = ...,
        is_stable: builtins.bool = ...,
        scatter_dimension_numbers: typing.Optional[xla_data_pb2.ScatterDimensionNumbers] = ...,
        precision_config: typing.Optional[xla_data_pb2.PrecisionConfig] = ...,
        source_target_pairs: typing.Optional[typing.Iterable[xla_data_pb2.SourceTarget]] = ...,
        domain_entry_sharding: typing.Optional[xla_data_pb2.OpSharding] = ...,
        domain_exit_sharding: typing.Optional[xla_data_pb2.OpSharding] = ...,
        constrain_layout: builtins.bool = ...,
        operand_shapes_with_layout: typing.Optional[typing.Iterable[xla_data_pb2.ShapeProto]] = ...,
        triangular_solve_options: typing.Optional[xla_data_pb2.TriangularSolveOptions] = ...,
        cholesky_options: typing.Optional[xla_data_pb2.CholeskyOptions] = ...,
        parameter_replication: typing.Optional[xla_data_pb2.ParameterReplication] = ...,
        outer_dimension_partitions: typing.Optional[typing.Iterable[builtins.int]] = ...,
        custom_call_has_side_effect: builtins.bool = ...,
        custom_call_output_operand_aliasing: typing.Optional[typing.Iterable[xla_data_pb2.CustomCallOutputOperandAliasing]] = ...,
        custom_call_schedule: global___CustomCallSchedule.ValueType = ...,
        delta: builtins.int = ...,
        indices_are_sorted: builtins.bool = ...,
        frontend_attributes: typing.Optional[xla_data_pb2.FrontendAttributes] = ...,
        unique_indices: builtins.bool = ...,
        rng_algorithm: xla_data_pb2.RandomAlgorithm.ValueType = ...,
        comparison_type: typing.Text = ...,
        is_cross_program_prefetch: builtins.bool = ...,
...
class HloComputationProto(google.protobuf.message.Message):
    ...
    def instructions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___HloInstructionProto]:
        ...
        pass
    @property
    def program_shape(self) -> xla_data_pb2.ProgramShapeProto:
    ...
    def __init__(self,
        *,
        ...
        program_shape: typing.Optional[xla_data_pb2.ProgramShapeProto] = ...,
        id: builtins.int = ...,
        root_id: builtins.int = ...,
        ) -> None: ...
...
class HloModuleProto(google.protobuf.message.Message):
    ...
    class ProfileInfo(google.protobuf.message.Message):
        ...
        profile_source: xla_data_pb2.ProfileSource.ValueType
        """The source of the optimization profile that this module contains."""

        compilation_event: xla_data_pb2.CompilationEvent.ValueType
    ...
    def computations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___HloComputationProto]:
        ...
        pass
    @property
    def host_program_shape(self) -> xla_data_pb2.ProgramShapeProto:
    ...
    @property
    def spmd_output_sharding(self) -> xla_data_pb2.OpSharding: ...
    @property
    def spmd_parameters_shardings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla_data_pb2.OpSharding]: ...
    @property
    ...
    def __init__(self,
        *,
        ...
        host_program_shape: typing.Optional[xla_data_pb2.ProgramShapeProto] = ...,
        id: builtins.int = ...,
        ...
        is_dynamic: builtins.bool = ...,
        spmd_output_sharding: typing.Optional[xla_data_pb2.OpSharding] = ...,
        spmd_parameters_shardings: typing.Optional[typing.Iterable[xla_data_pb2.OpSharding]] = ...,
        profile_info: typing.Optional[typing.Iterable[global___HloModuleProto.ProfileInfo]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["dynamic_parameter_binding",b"dynamic_parameter_binding","host_program_shape",b"host_program_shape","input_output_alias",b"input_output_alias","schedule",b"schedule","spmd_output_sharding",b"spmd_output_sharding"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["computations",b"computations","cross_program_prefetches",b"cross_program_prefetches","dynamic_parameter_binding",b"dynamic_parameter_binding","entry_computation_id",b"entry_computation_id","entry_computation_name",b"entry_computation_name","host_program_shape",b"host_program_shape","id",b"id","input_output_alias",b"input_output_alias","is_dynamic",b"is_dynamic","name",b"name","profile_info",b"profile_info","schedule",b"schedule","spmd_output_sharding",b"spmd_output_sharding","spmd_parameters_shardings",b"spmd_parameters_shardings"]) -> None: ...
...
class HeapSimulatorTrace(google.protobuf.message.Message):
    ...
    class Event(google.protobuf.message.Message):
        """The trace includes a list of events, where each event describes one
        action performed by the heap simulator.
        """
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
        class _Kind:
            ValueType = typing.NewType('ValueType', builtins.int)
        ...
        class _KindEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[HeapSimulatorTrace.Event._Kind.ValueType], builtins.type):
            ...
            """A buffer was shared with another (canonical) buffer. This is
            similar to ALLOC, except that instead of allocating a new region
            of memory, the memory region of the canonical buffer is directly
            re-used. Multiple buffers may share with the same canonical
            buffer. The lifetime of the canonical buffer is extended to the
            union of all lifetimes.
            """
        ...
        computation_name: typing.Text
        """The HloInstruction that the simulation was processing that caused
        this event to occur, identified by its computation and instruction
        name. E.g. buffers defined by instruction A are allocated when
        processing A.
        """

        instruction_name: typing.Text
        share_with_canonical_id: builtins.int
        """The id of the canonical LogicalBuffer that the buffer shares with.
        Only set for SHARE_WITH events.
        """
...
class HloSnapshot(google.protobuf.message.Message):
    ...
    def hlo(self) -> global___HloProto:
        ...
        pass
    @property
    def arguments(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[xla_data_pb2.LiteralProto]:
        """The arguments passed to the graph."""
        pass
    @property
    def result(self) -> xla_data_pb2.LiteralProto:
    ...
    def __init__(self,
        *,
        ...
        arguments: typing.Optional[typing.Iterable[xla_data_pb2.LiteralProto]] = ...,
        result: typing.Optional[xla_data_pb2.LiteralProto] = ...,
        execution_platform: typing.Text = ...,
        ) -> None: ...
...
class HloModuleMetadataProto(google.protobuf.message.Message):
    ...
    def partitioned_module_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        """The canonical module ids of the modules that this one is partitioned
        into, if applicable.
        """
        pass
    @property
...
class HloPassMetadata(google.protobuf.message.Message):
    ...
    """The unique_id of the module that this pass is run on. May be different
    from the canonical_module_id of the HloModuleMetadata that this
    HloPassMetadata is inside.
    """
...
class EntryFunctionAttributes(google.protobuf.message.Message):
    ...
    class BufferParameterAttributes(google.protobuf.message.Message):
        ...
        """TODO(hanbinyoon): Deprecate when optional fields are available in
        proto3 (Protocol Buffers v3.15.0).
        """
        ...
        def lmhlo_param_shape_index(self) -> global___EntryFunctionAttributes.ShapeIndex:
            ...
            pass
        lmhlo_constant_name: typing.Text
        ...
        def __init__(self,
            *,
            lmhlo_params: builtins.int = ...,
            lmhlo_params_present: builtins.bool = ...,
            lmhlo_param_shape_index: typing.Optional[global___EntryFunctionAttributes.ShapeIndex] = ...,
            lmhlo_constant_name: typing.Text = ...,
            lmhlo_must_alias: builtins.bool = ...,
            lmhlo_output_index: typing.Optional[global___EntryFunctionAttributes.ShapeIndex] = ...,
            ) -> None: ...
    ...
    result_xla_shape: typing.Text
    """xla::Shape in string format."""

    def __init__(self,
        *,
        buffers: typing.Optional[typing.Iterable[global___EntryFunctionAttributes.BufferParameterAttributes]] = ...,
        result_xla_shape: typing.Text = ...,
        ) -> None: ...
...
class GpuBefExecutableProto(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        hlo_module_proto: typing.Optional[global___HloModuleProto] = ...,
        bef: builtins.bytes = ...,
        entry_func_attrs: typing.Optional[global___EntryFunctionAttributes] = ...,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bef",b"bef","entry_func_attrs",b"entry_func_attrs","hlo_module_proto",b"hlo_module_proto"]) -> None: ...
global___GpuBefExecutableProto = GpuBefExecutableProto
